...
if __name__ == '__main__':
    if NUM_GPUS > 1:
        trainer = Trainer(gpus=NUM_GPUS, accelerator='ddp', fast_dev_run=False)
    elif NUM_GPUS == 1:
        trainer = Trainer(gpus=NUM_GPUS, fast_dev_run=False,
                          log_every_n_steps=1)
    else:
        trainer = Trainer(fast_dev_run=False, log_every_n_steps=1)
